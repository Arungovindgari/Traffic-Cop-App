...
<head>
 ...
 <body>
 <br>
    <h3><center><u>Traffic Violations<u></center></h3>  
    <br>
    <hr>
<% 
  ...
  <thead>
    <tr>
    <center> <th scope="col">Challen_Id.:</th></center>
   <center>   <th scope="col">Reg Number:</th></center>
   <center>    <th scope="col">Violator Name:</th></center>
    <center>   <th scope="col">Violation Type:</th></center>
     <center>  <th scope="col"> Selected Vehicle :</th></center>
     <center>  <th scope="col">Location</th></center>
      <center>  <th scope="col">Compounding Fine</th></center>
      <center>    <th scope="col">Vehicle_type</th></center>
       <center> <th scope="col">Date_Time</th></center>
    </tr>
  </thead>
	...
	%> 
	 <tbody>    
	   ...
	   <td><center><%=rs.getString("location") %></center></td>
	    ...
	    <td><center><%=rs.getString("vechile_type") %></center></td>
